...
import { ArrowLeftIcon, ArrowUpRightFromSquareIcon, Calendar, CheckCircle2, ChevronLeftIcon, ChevronRightIcon, DollarSign, Eye, LineChart, Loader2Icon, MapPin, MessageSquareMoreIcon, ShoppingBagIcon, User } from 'lucide-react';
...
const ListingDetails = () => {
  ...
  const purchaseAccount = async () =>{
    try {
      ...
      const {data} = await api.get(`/api/listing/purchase-amount/${listing.id}`,{headers :{Authorization : `Bearer ${token}`}})
      toast.dismissAll();
        ...
        <div className='flex-1 max-md:w-full'> 
          ...
          {images?.length>0 && (
            <div className='bg-white rounded-xl border border-gray-200 mb-5 overflow-hidden'>
              <div className='p-4'><h4>Screenshot & Proofs</h4></div>
              {/* slider container */}
