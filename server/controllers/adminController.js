...
// controller for checking if user is admin or not
...
//contoller for getting all unverified listings with credentials submitted
...
export const getAllUnchangedCredential = async (req, res)=>{
  try {
    const listings = await prisma.listing.findMany({
...
//chnage credential for verified lisiting
...
export const getAllTransaction = async (req, res)=>{
    try {
        ...
        // get customer details for each transaction and add it to the transaction
...
//conrtoller for getting all withdraw requests
