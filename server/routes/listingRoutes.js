...
import { addCredential, addListing, deleteUserListing, getAllPublicListing, getAllUserListing, getAllUserOrders, markedFeature, purchaseAccount, toggleStatus, updateListing, withdrawAmount } from '../controllers/listingController.js';
...
listingRouter.put('/featured/:id',protect, markedFeature)
listingRouter.get('/user-orders',protect, getAllUserOrders)
listingRouter.post('/withdraw',protect, withdrawAmount)
listingRouter.get('/purchase-amount/:listingId',protect, purchaseAccount)
